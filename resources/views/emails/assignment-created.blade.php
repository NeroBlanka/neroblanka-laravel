...
<div class="wrapper">
  ...
  <div class="card">
    <div class="title">Nouvelle mission assignée</div>
    <div class="label">Bonjour</div>
    <div class="value">{{ $freelance->full_name }}</div>
    <div class="label">Projet</div>
    <div class="value">{{ $assignment->project->title }}</div>
    <div class="label">Service</div>
    <div class="value">{{ $assignment->project->service_type ?? '—' }}</div>
    <div class="label">Deadline</div>
    <div class="value">{{ $assignment->project->deadline ? $assignment->project->deadline->format('d/m/Y') : '—' }}</div>
    @if($assignment->internal_notes)
    <hr class="divider">
    <div class="label">Notes internes</div>
    <div class="value">{{ $assignment->internal_notes }}</div>
    @endif
  </div>
