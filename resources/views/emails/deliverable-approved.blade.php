...
<div class="wrapper">
  ...
  <div class="card">
    <div class="title">Livrable approuvé</div>
    ...
    <div class="label">Fichier approuvé</div>
    <div class="value">{{ $deliverable->file_name }} (v{{ $deliverable->version }})</div>
    <div class="label">Approuvé le</div>
    <div class="value">{{ $deliverable->approved_at?->format('d/m/Y à H:i') }}</div>
  </div>
